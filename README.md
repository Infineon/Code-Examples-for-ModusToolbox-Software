...
| [Amazon FreeRTOS Examples](https://github.com/cypresssemiconductorco?q=afr-example%20NOT%20Deprecated) |This link displays a list of all Cypress Amazon FreeRTOS examples. In addition, the Amazon FreeRTOS repository [demo folder](https://github.com/cypresssemiconductorco/amazon-freertos/tree/master/demos) contains multiple examples, including AWS IoT. Some examples may not be supported on Cypress hardware. See the Getting Started guide for each board, available through the repository [ReadMe file](https://github.com/cypresssemiconductorco/amazon-freertos/blob/master/README.md).|
